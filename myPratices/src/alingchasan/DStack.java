...
//        System.out.println(new DStack().countOfAtoms("Be32"));
        ...
        System.out.println(new DStack().evaluate("(let x 2 (mult x (let x 3 y 4 (add x y))))"));
...
//                防止连续两个运算符号比如：(-  -(  *(
    ...
    public String countOfAtoms(String formula) {
        ...
        stack.push(new HashMap<>());//可以理解成记录当前环境下的变量的统计
        ...
        while (i < n) {
            ...
            if (c == '(') {
                ...
                Map<String, Integer> popedMap = stack.pop();//内部递归方法中 已经统计的原子个数
                Map<String, Integer> toMap = stack.peek();//上一层方法中记录的原子个数
